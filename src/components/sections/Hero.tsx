function Hero() {
  return (
    <section
      id="home"
      className="mx-auto max-w-[50rem] text-center mb-28 sm:mb-0 scroll-mt-[100rem]"
    >
      <div className="flex items-center justify-center mb-10">
        <div className="relative">
          ...
          />
          <span className="absolute bottom-0 right-0 text-4xl animate-wave origin-bottom-right">
            👋
          </span>
        </div>
      </div>
      ...
      <h1 className="mb-10 mt-4 px-4 text-[--text-2xl] sm:text-[--text-4xl] font-medium !leading-[1.5]">
        ...
        <span className="font-bold">JavaScript Developer.</span> <br />I
